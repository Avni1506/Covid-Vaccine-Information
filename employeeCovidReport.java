...
/**
 * Servlet implementation class employeeCovidReport
 */
@WebServlet("/employeeCovidReport")
public class employeeCovidReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet r=s.executeQuery("select * from dependent_details D inner join covid_details C where (D.RID=C.P_ID) and D.E_ID='"+id+"'");
		   ...
		   //Set Column widths
		    float[] columnWidths = {25f,25f,30f,30f,20f,25f,25f,25f};
		    ...
		    PdfPCell cell10 = new PdfPCell(new Paragraph("From Date"));
		    ...
		    PdfPCell cell12 = new PdfPCell(new Paragraph("To Date"));
