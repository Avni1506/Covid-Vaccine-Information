...
<div class="vaccine">
<form action="vaccineDetails" method="post">
   ...
   <div class="scrollit">
    <table>
       ...
       <tr>
          <td>Dose1 Date* :</td>
          <td><input type="date" name="date1" max="<%=java.time.LocalDate.now()%>"></td>
       </tr>
       <tr>
          <td>Pincode* :</td>
       ...
       <tr>
          <td>Dose2 Date :</td>
          <td><input type="date" name="date2" max="<%=java.time.LocalDate.now()%>"></td>
       </tr>
       <tr>
          <td>Pincode :</td>
          <td><input type="text" name="pin2"></td>
       </tr>
    </table>
    <%
        	  }
    ...
    <%
          ...
          ResultSet result=st.executeQuery("select * from vaccine_details");
          while(result.next()){
    %>
    <tr>
