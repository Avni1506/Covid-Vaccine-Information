...
/**
 * Servlet implementation class vaccineReports
 */
@WebServlet("/vaccineReports")
public class vaccineReports extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet r=s.executeQuery("select * from dependent_details D join vaccine_details V where D.RID=V.P_ID");
		   ...
		   //Set Column widths
		    float[] columnWidths = {15f,15f,15f,30f,30f,30f,20f,25f,30f,25f,20f,25f,20f};
