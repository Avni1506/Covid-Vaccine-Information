...
/**
 * Servlet implementation class employeeSelfReport
 */
@WebServlet("/employeeSelfReport")
public class employeeSelfReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Rectangle pageSize=new Rectangle(1200,550);
		...
		try
		{
		    ...
		    document.add(para2);
		    Paragraph para3=new Paragraph("Self Details",TIME_ROMAN_SMALL);
		   ...
		   //Set Column widths
		    float[] columnWidths = {20f,25f,30f,30f,20f,25f,40f,30f,15f,25f,15f,30f,20f,30f};
		    table.setWidths(columnWidths); 

		    PdfPCell cell1 = new PdfPCell(new Paragraph("EID"));
		    ...
		    PdfPCell cell2 = new PdfPCell(new Paragraph("Relation"));
		    ...
		    while(r.next()){
		    	...
		    	table.addCell(r.getString(18));
		    	table.addCell(r.getString(19));
		    	table.addCell(r.getString(20));
		    	table.addCell(r.getString(21));
		    	table.addCell(r.getString(22));
