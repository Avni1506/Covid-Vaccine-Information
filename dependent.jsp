...
<tr>
<td>First Name :</td>
<td><input type="text" size="30" max="20" value="${param.fname }" readonly></td></tr>
<tr>
<td><a href="newDependent.jsp"><button type="button">Back</button></a></td></tr>
  ...
  <tr>
  <td>First Name* : </td>
  <td><input type="text" size="30" name="fname" max="20" value="${param.fname }" readonly></td>
  </tr>
  <tr></tr><tr></tr>
  <tr>
  <td>Last Name : </td>
  <td><input type="text" size="30" name="lname" max="20"></td>
  </tr>
  <tr></tr><tr></tr>
  <tr>
  <td>Gender : </td>
  <td><select name="gender">
          ...
          <tr>
      <td> Date of Birth : </td>
      <td><input type="date" size="12" name="dob" max="<%=java.time.LocalDate.now()%>"></td>
      </tr>
   </table>
   <br><br>
